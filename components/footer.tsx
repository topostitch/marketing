      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr] gap-10 mb-12">
          <div className="space-y-4 max-w-xl">
            ...
            <a href="mailto:jacob@topostitch.dev" className="inline-block text-sm text-foreground underline underline-offset-4 hover:text-accent transition-colors">jacob@topostitch.dev</a>
          </div>
          ...
          <nav className="grid grid-cols-2 gap-6" aria-label="Footer navigation">
            ...
            <div className="space-y-3">
              ...
              <Link href="/#contact" className="block text-sm text-muted-foreground hover:text-foreground">Pilot conversations</Link>
              <a href="mailto:jacob@topostitch.dev" className="block text-sm text-muted-foreground hover:text-foreground">Contact</a>
            </div>
          </nav>
        </div>
