      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-center justify-center pt-2">
            <Link href="#contact" className="inline-flex min-h-12 items-center justify-center rounded-lg bg-background px-7 py-3 text-base font-medium text-foreground hover:bg-background/90 transition-colors">Talk about a pilot</Link>
            <Link href="/platform" className="inline-flex min-h-12 items-center justify-center rounded-lg border border-background/40 px-7 py-3 text-base font-medium text-background hover:bg-background/10 transition-colors">See the workflow</Link>
          </div>
        </div>
      </div>
    </section>
